defmodule Bigtable.Ecto.Migration.Runner do
  ...
  alias Bigtable.Ecto.Migration.Index
  alias Bigtable.Ecto.Migration.Constraint
  alias Bigtable.Ecto.Migration.Command
